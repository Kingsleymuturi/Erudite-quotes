...
export class QuotesComponent implements OnInit {
  ...
  quotes:Quote[] = [
    ...
    new Quote (5,'Otis','“Most of the important things in the world have been accomplished by people who have kept on trying when there seemed to be no hope at all.”','Dale Carnegie',new Date(2020,1,6),0,0),
    new Quote (6,'Mulamwah','“Whenever you find yourself on the side of the majority, it is time to reform (or pause and reflect).”','Mark Twain',new Date(2020,0,2),0,0),
  ];
  get sortQuotes() {
